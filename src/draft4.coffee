...
attributes = require "./draft4/attributes"

module.exports = class Validator

  DRAFT_4_URI = "http://json-schema.org/draft-04/schema#"
  ...
  constructor: (schemas...) ->
    ...
    for schema in schemas
      if schema["$schema"]? && schema["$schema"] != DRAFT_4_URI
